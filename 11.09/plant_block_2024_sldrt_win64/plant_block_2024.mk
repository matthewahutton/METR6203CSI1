...
MODEL                := plant_block_2024
MODULES              := rt_matrx.c rt_printf.c plant_block_2024_data.c plant_block_2024_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c ECPDSPDriver.c
MAKEFILE             := plant_block_2024.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := plant_block_2024_ref.rsp
...
# additional includes
REQ_INCLUDES += ;$(WQ)U:/New folder/csi1$(WQ);$(WQ)U:/New folder/csi1/plant_block_2024_sldrt_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ);$(WQ)C:/ECP/Model750$(WQ)
...
ECPDSPDriver.o : C:/ECP/Model750/ECPDSPDriver.c
	$(call BUILDOBJ, $(CC))
...
PRECOMPLIBSRCDIRS := C:/ECP/Model750 $(MATLAB_ROOT)/rtw/c/src $(MATLAB_ROOT)/simulink/src $(MATLAB_ROOT)/toolbox/simulink/blocks/src $(MATLAB_ROOT)/rtw/c/src/ext_mode/common 
