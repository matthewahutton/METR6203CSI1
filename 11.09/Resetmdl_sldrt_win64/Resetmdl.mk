...
MODEL                := Resetmdl
MODULES              := rt_matrx.c rt_printf.c Resetmdl_data.c Resetmdl_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c ECPDSPReset.c
...
# additional includes
REQ_INCLUDES += ;$(WQ)U:/New folder/csi1$(WQ);$(WQ)U:/New folder/csi1/Resetmdl_sldrt_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ)
...
ECPDSPReset.o : C:/ECP/Model750/ECPDSPReset.c
	$(call BUILDOBJ, $(CC))
