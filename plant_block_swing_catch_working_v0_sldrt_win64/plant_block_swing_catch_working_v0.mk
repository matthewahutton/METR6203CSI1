...
MODULES              := rt_matrx.c rt_printf.c plant_block_swing_catch_working_v0_data.c plant_block_swing_catch_working_v0_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c ECPDSPDriver.c
...
# additional includes
REQ_INCLUDES += ;$(WQ)U:/6203/CSI1$(WQ);$(WQ)U:/6203/CSI1/plant_block_swing_catch_working_v0_sldrt_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ);$(WQ)C:/ECP/Model750$(WQ)
